...
protocol which Tor uses is called Diffie-Hellman\footnote{W. Diffie and M.E. 
Hellman, New directions in cryptography, IEEE Transactions on Information Theory
22 (1976), 644-654.} key exchange. The generated keys are only used for one
